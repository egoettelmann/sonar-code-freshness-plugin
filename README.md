SonarQube CodeFreshness Plugin [![Build Status](https://travis-ci.org/SonarSource/sonar-custom-plugin-example.svg?branch=7.x)](https://travis-ci.org/egoettelmann/sonar-custom-plugin-example)
==========
